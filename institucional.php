...
<body>
    ...
    <div class="container2">
        <div class="botoes-empresa">
            <a href="./politicasegura.php">
                <button id=Politica_segpriv class="btn btn-secondary">Política de Segurança e
                    Privacidade</button>
            </a>
            <a href="./trocaedev.php">
                <button id=Politica_troca class="btn btn-secondary" href="#">Política de Troca e Devoluções</button>
            </a>
            <a href="./termosecond.php">
                <button id=Termosecondicoes class="btn btn-secondary" href="#">Termos e Condições</button>
            </a>
            <a href="./quemsomos.php">
                <button id=Quemsomos class="btn btn-secondary" href="#">Quem Somos</button>
            </a>
