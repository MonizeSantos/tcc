...
<body>
    ...
    <h1>Gamers e Streamers</h1>
        <p>Gamers e streamers são um perfil criado para todos aqueles amantes do universo dos jogos. Seja por diversão
            ou ao trabalho, acabam por necessitar das melhores tecnologias disponíveis aliadas também pelo melhor custo
            benefício que possa ser empregado em cada equipamento.</p>
    </div>

    <<div class="sliderglobal">
        <a href="./linhagamma.php">
        <img src="./img/pc 1.jpg" />
        </a>
        <a href="./linhatoco.php">
        <img src="./img/pc 1.jpg" />
        </a>
    </div>
