...
<head>
    <title>BootKamp Informática</title>
...
use Dompdf\Dompdf;
    ...
    //exibir a página
    $dompdf->stream(
        "Orçamento_Bootkamp.pdf",
        array(
            "Attachment"=> false //para realizar o download automático basta alterar para true
        )
